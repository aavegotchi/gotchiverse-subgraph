...
import { EditInstallationType } from "../../generated/InstallationDiamond/InstallationDiamond";
import { InstallationType } from "../../generated/schema";
import {
    BIGINT_EIGHT,
    BIGINT_FIVE,
    BIGINT_FOUR,
...
import { handleEditInstallationType } from "../../src/mappings/installation";

let mockEvent = newMockEvent();
let installationId = BIGINT_SEVEN;
describe("handleEditInstallationType", () => {
    beforeAll(() => {
        // prepare event
        let event = new EditInstallationType(
            mockEvent.address,
            mockEvent.logIndex,
        ...
        handleEditInstallationType(event);
    });
    ...
    test("it should create an event entity", () => {
        ...
        assert.fieldEquals("EditInstallationTypeEvent", id, "id", id);
        assert.fieldEquals(
