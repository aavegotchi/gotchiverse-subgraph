...
NETWORK_CONSTANTS.set(
    "base-sepolia",
    new Map<string, string>()
        .set("REALM_DIAMOND", "0x331f97b45Cd0AA642Ce57ABFb93d26D32D0E8115")
        .set("TILE_DIAMOND", "0x51972061e0c77dEb8244314c8a96a4C30164fE16")
        .set(
            "INSTALLATION_DIAMOND",
            "0x112E410957977C46C1E9206FcE92CC88Ef2D3A73"
        )
);
