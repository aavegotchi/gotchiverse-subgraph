...
NETWORK_CONSTANTS.set(
    "base-sepolia",
    new Map<string, string>()
        .set("REALM_DIAMOND", "0x37D140074B2f771bEa7ef23288EB87064e45bF8D")
        .set("TILE_DIAMOND", "0x96B19Fa954d961fAD4b665e3259C72466ca4C1dA")
        .set(
            "INSTALLATION_DIAMOND",
            "0x5Aefdc5283B24EEa7b50FFBBf7FB8A2bD4537609"
        )
);
